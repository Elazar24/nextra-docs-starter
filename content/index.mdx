...
This is a university project for taking physics notes in documentation format.

This project aims to provide a structured and organized way to document physics concepts, making it easier for students to study and reference materials.

It will include sections on various physics topics, formulas, and explanations, all formatted in a clear and concise manner using Nextra. With the benefit of having code snippets, diagrams, and examples, this documentation will serve as a valuable resource for anyone looking to visually improve their understanding of physics.
